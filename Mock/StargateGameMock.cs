...
namespace Stargate.Mock
{
    public class StargateGameMock
    {
        ...
        public static void InitPlayerWithMock(StargateGame stargateGame, Player p)
        {
            ...
            // stargateGame.GameState.CreatePlayerDeck(p, stargateGame.Library.GetCardsFromGuidList(new List<string> {  }));



           // stargateGame.GameState.CreatePlayerDeck(p, stargateGame.Library.GetCardsFromGuidList(new List<string> { "cd9301f3-3374-4065-a143-cdec5b998ff8", "1ac9edb7-305d-4faf-93c0-d52f81c33aa2", "3c381256-8ecd-4a17-ae67-dbe4a7b5305a" })) ;

             stargateGame.GameState.CreatePlayerDeck(p, stargateGame.Library.GetCardsFromGuidList(new List<string> { "8a097812-9963-4da7-ae55-0ff0196bfcff", "79974bc9-9b81-41e1-8868-c75f8fc58837", "79974bc9-9b81-41e1-8868-c75f8fc58837", "dd59e9ee-9cf8-4d61-b891-5477c550b2b1", "dd59e9ee-9cf8-4d61-b891-5477c550b2b1", "3c381256-8ecd-4a17-ae67-dbe4a7b5305a" , "3c381256-8ecd-4a17-ae67-dbe4a7b5305a" }));
