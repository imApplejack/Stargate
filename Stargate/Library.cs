        ...
        public SGCard getCardById(string id) // id = hash bdd
        {
            ...
            switch (id)
            {
                case 
                    ...
                    return new SGCard() { Id = id, Name = "Anise", Cost = 4, Culture = 2, Science = 1, Type= Enum.CardType.SupportCharacter};

                case "4901fb59-e7cc-47d4-8f3a-4f1f2e93f78d":
                    return new SGCard() { Id = id, Name = "Jack O'Neill", Cost = 3, Culture = 0, Science = 1, Combat = 3, Ingenuity = 3 , Type = Enum.CardType.TeamCharacter };

                case "dd59e9ee-9cf8-4d61-b891-5477c550b2b1":
                    return new SGCard() { Id = id, Name = "Yu", Cost = 2, Culture = 2, Combat = 2, Revive = 3,  Type = Enum.CardType.Adversary };
                default: return null;
